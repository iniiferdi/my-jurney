                                        ...
                                        <tr>
                                            ...
                                            <tr>
                                                <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                  <div class="flex px-2 py-1">
                                                    <div class="flex flex-col justify-center">
                                                      <h6 class="mb-0 text-sm leading-normal">{{$semester->id}}</h6>
                                                    </div>
                                                  </div>
                                                </td>
                                                ...
                                                <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                    ...
                                                    <p class="mb-0 text-xs font-semibold leading-tight">{{$semester->semester_name}} <span class="p-1 text-white bg-green-700 rounded-lg">Acctive</span></p>
                                                    @else
                                                    <p class="mb-0 text-xs font-semibold leading-tight">{{$semester->semester_name}} </p>
                                                    @endif
                                                ...
                                                <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                  <a href="edit-semester/{{$semester->id}}" class="text-xs font-semibold leading-tight text-blue-600"> Edit </a>
                                                  <span>|</span>
                                                  <a class="text-xs font-semibold leading-tight text-red-600" href="delete-semester/{{$semester->id}}">Delete</a>
                                                </td>
                                              </tr>
                                            @endforeach
